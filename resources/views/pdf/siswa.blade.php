    ...
    <div>
        ...
        <div class="row">
            ...
            <div>
                ...
                @php
                    $masked = substr($siswa->tanggal_lahir_calon_siswa, 0, 2) . '**-**-' . substr($siswa->tanggal_lahir_calon_siswa, 8, 1) . '*';
                @endphp
                {{ $masked }}
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div>
                @php
                    $masked = substr($siswa->telepon_orang_tua_wali,0,3) . "******" . substr($siswa->telepon_orang_tua_wali,-3)
                @endphp
                {{ $masked }}
            </div>
        </div>
